...
--
-- Host: localhost    Database: cnpm23
-- ------------------------------------------------------
...
INSERT INTO `lan_dong` VALUES (1,1,'2020-06-24','2020-12-08'),(2,2,'2020-10-14','2020-12-14');
...
--
-- Table structure for table `phi_dong_gop`
--
...
--
-- Dumping data for table `phi_dong_gop`
--

LOCK TABLES `phi_dong_gop` WRITE;
/*!40000 ALTER TABLE `phi_dong_gop` DISABLE KEYS */;
INSERT INTO `phi_dong_gop` VALUES (1,13,1,'2020-11-11',500000),(2,14,1,'2020-12-15',350000),(3,15,1,'2020-12-14',650000),(4,13,2,'2020-09-03',350000),(5,14,2,'2020-05-12',500000),(6,16,2,'2020-12-19',750000),(7,16,3,'2020-11-24',450000),(8,14,3,'2020-12-24',550000),(9,15,4,'2020-12-20',300000),(10,13,4,'2020-07-14',350000),(11,16,4,'2020-07-14',850000),(12,14,1,'2020-07-14',350000),(13,13,3,'2020-07-14',600000);
/*!40000 ALTER TABLE `phi_dong_gop` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `phi_ve_sinh` VALUES (1,13,72000,'2020-02-10 00:00:00',1,3,4,2020),(47,14,72000,'2020-12-01 10:53:29',0,5,10,2020),(48,15,72000,'2020-12-01 10:53:29',0,4,10,2021),(55,16,72000,'2020-12-01 10:53:30',1,2,10,2020);
...
INSERT INTO `su_kien` VALUES (1,'Trung thu cho em','TTCE','2020-04-04','2020-11-12',2020),(2,'Miền Trung Thân Yêu','MTTY','2020-04-01','2020-12-02',2020),(3,'Xuân Yêu Thương','XYT','2020-01-10','2020-11-15',2020),(4,'Qũy Trẻ Em','QTE','2020-02-03','2020-10-11',2020);
...
INSERT INTO `thanh_vien_cua_ho` VALUES (26,14,'Chủ hộ'),(27,13,'Vợ'),(28,13,'Chủ hộ'),(29,15,'Chủ hộ'),(30,15,'Vợ'),(31,15,'Con trai'),(32,15,'Con gái'),(33,16,'Chủ hộ'),(34,16,'Vợ'),(35,16,'Con trai'),(36,16,'Con gái'),(37,14,'Bố'),(38,14,'Mẹ');
...
--
-- Dumping events for database 'cnpm23'
--

--
-- Dumping routines for database 'cnpm23'
--
...
-- Dump completed on 2020-12-08  9:14:43
