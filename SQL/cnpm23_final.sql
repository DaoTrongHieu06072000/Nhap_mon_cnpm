...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 02, 2020 lúc 05:28 PM
...
--
-- Cấu trúc bảng cho bảng `lan_dong`
--
...
(6, 1, '2020-09-16', '2020-12-15'),
(7, 1, '2020-02-10', '2020-11-16'),
(8, 1, '2020-08-10', '2020-12-27');
...
--
-- Đang đổ dữ liệu cho bảng `loai_dong_gop`
--

INSERT INTO `loai_dong_gop` (`idloai_dong_gop`, `name`, `code`) VALUES
(1, 'Trung thu cho em', 'TTCE'),
(2, 'Miền Trung Thân Yêu', 'MTTY'),
(3, 'Xuân Yêu Thương', 'XYT'),
(4, 'Qũy Trẻ Em', 'QTE');
...
INSERT INTO `phi_dong_gop` (`iddong_gop`, `idHoKhau`, `idLoaiDongGop`, `idLanDong`, `ngayDong`, `so_tien`) VALUES
(1, 13, 1, 1, '2020-11-11', 500000),
(2, 14, 1, 1, '2020-12-15', 350000),
(3, 15, 1, 1, '2020-12-14', 650000),
(4, 13, 2, 1, '2020-09-03', 350000),
(5, 14, 2, 6, '2020-05-12', 500000),
(6, 16, 2, 6, '2020-12-19', 750000),
(7, 16, 3, 7, '2020-11-24', 450000),
(8, 14, 3, 7, '2020-12-24', 550000),
(9, 15, 4, 8, '2020-12-20', 300000),
(10, 13, 4, 8, '2020-07-14', 350000),
(11, 16, 4, 8, '2020-07-14', 850000),
(12, 14, 1, 1, '2020-07-14', 350000),
(13, 13, 3, 7, '2020-07-14', 600000);
...
CREATE TABLE `phi_ve_sinh` (
  `idphi_ve_sinh` int(11) NOT NULL,
  `idHoKhau` int(11) NOT NULL,
  `phiVeSinh` int(11) NOT NULL,
  `ngayNop` datetime NOT NULL,
  `Da_thu` int(10) UNSIGNED DEFAULT 0,
  `SoNhanKhau` int(10) UNSIGNED DEFAULT 1,
  `Thang` int(10) UNSIGNED DEFAULT NULL,
  `Nam` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `phi_ve_sinh`
--
...
(47, 14, 72000, '2020-12-01 10:53:29', 0, 5, 10, 2020),
...
--
ALTER TABLE `phi_dong_gop`
  MODIFY `iddong_gop` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
